...
<body>
	...
	<div id="leftnav" style="background-color:#F433FF">
		<ul>
			<li><a href="admin_home.php" >Dashboard</a></li>
			<li><a href="admin_home.php">Products</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">General items</a></li>
					...
					<li><a href="admin_running.php"style="font-size:15px; margin-left:15px;">ExpectedMothers Clothes</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>General Clothes</h2></center></div>
			<br />
