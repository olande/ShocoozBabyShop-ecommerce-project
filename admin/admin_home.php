...
<body>
	...
	<div id="leftnav" style="background-color:#FF7733">
		<ul>
			<li><a href="admin_home.php" style="color:#333;">Dashboard</a></li>
			<li><a href="admin_home.php" style="color: blue">Products</a>
				<ul>
	...
	<div id="container" style="min-width: 310px; height: 600px; max-width: 1000px; margin: 0 auto; background:blue; float:left;"></div>
