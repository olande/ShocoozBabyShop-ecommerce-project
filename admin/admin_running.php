...
<body>
	...
	<div id="leftnav" style="background-color: #14F3D8">
		<ul>
			<li><a href="admin_home.php" style="color:#333;">Dashboard</a></li>
			<li><a href="admin_home.php">Products</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">General Clothes</a></li>
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Baby Clothes</a></li>
					<li><a href="admin_football.php" style="font-size:15px; margin-left:15px;">Kids Clothes</a></li>
					<li><a href="admin_running.php"style="font-size:15px; margin-left:15px;">Expected Mothers Clothes</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Expected Mothers Clothes </h2></center></div>
			<br />
